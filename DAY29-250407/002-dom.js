...
// 1. getElementById: id값을 이용-> 단일 요소
const description = document.getElementById("description");
description.style.border= "1px cilid black";
