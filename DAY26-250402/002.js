...
console.log("1. 점 표기법: ", licat.age, licat.company-name);  // 명명규칙을 만족하는 키만 접근 가능
console.log("2. 대괄호 표기법: ", licat["name"], licat["age"], licat["company-name"], licat["hasJob"]);
